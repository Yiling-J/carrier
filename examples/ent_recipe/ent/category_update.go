...
func (cu *CategoryUpdate) RemoveRecipeIDs(ids ...int) *CategoryUpdate {
	cu.mutation.RemoveRecipeIDs(ids...)
	return cu
}
...
func (cu *CategoryUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if cu.mutation.RecipeCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   category.RecipeTable,
			Columns: category.RecipePrimaryKey,
			Bidi:    false,
	...
	if nodes := cu.mutation.RemovedRecipeIDs(); len(nodes) > 0 && !cu.mutation.RecipeCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   category.RecipeTable,
	...
	if nodes := cu.mutation.RecipeIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   category.RecipeTable,
...
func (cuo *CategoryUpdateOne) RemoveRecipe(r ...*Recipe) *CategoryUpdateOne {
	...
	return cuo.RemoveRecipeIDs(ids...)
}
...
func (cuo *CategoryUpdateOne) sqlSave(ctx context.Context) (_node *Category, err error) {
	...
	if nodes := cuo.mutation.RemovedRecipeIDs(); len(nodes) > 0 && !cuo.mutation.RecipeCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   category.RecipeTable,
	...
	if nodes := cuo.mutation.RecipeIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   category.RecipeTable,
