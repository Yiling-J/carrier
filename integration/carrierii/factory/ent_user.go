...
type entUserMutation struct {
	ageType int
	ageFunc func(ctx context.Context, i *EntUserMutator, c int, creator *ten.UserCreate) error

	emailType int
	emailFunc func(ctx context.Context, i *EntUserMutator, c int, creator *ten.UserCreate) error

	nameType int
	nameFunc func(ctx context.Context, i *EntUserMutator, c int, creator *ten.UserCreate) error
...
func (*entUserMutation) ageSequenceMutateFunc(fn func(ctx context.Context, i int) (int, error)) func(m *entUserMutation) {
	return func(m *entUserMutation) {
		...
		m.ageFunc = func(ctx context.Context, i *EntUserMutator, c int, creator *ten.UserCreate) error {
			if fn == nil {
				return nil
			}
			value, err := fn(ctx, c)
...
func (*entUserMutation) emailSequenceMutateFunc(fn func(ctx context.Context, i int) (string, error)) func(m *entUserMutation) {
	return func(m *entUserMutation) {
		...
		m.emailFunc = func(ctx context.Context, i *EntUserMutator, c int, creator *ten.UserCreate) error {
			if fn == nil {
				return nil
			}
			value, err := fn(ctx, c)
...
func (*entUserMutation) nameSequenceMutateFunc(fn func(ctx context.Context, i int) (string, error)) func(m *entUserMutation) {
	return func(m *entUserMutation) {
		...
		m.nameFunc = func(ctx context.Context, i *EntUserMutator, c int, creator *ten.UserCreate) error {
			if fn == nil {
				return nil
			}
			value, err := fn(ctx, c)
...
func (b *EntUserBuilder) Create(ctx context.Context) (*ten.User, error) {
	...
	var preSlice = []func(ctx context.Context, i *EntUserMutator, c int, creator *ten.UserCreate) error{}
	var lazySlice = []func(ctx context.Context, i *EntUserMutator, c int, creator *ten.UserCreate) error{}
	var postSlice = []func(ctx context.Context, i *ten.User, c int, creator *ten.UserCreate) error{}
	...
	if b.ageOverriden {
		preSlice = append(preSlice, func(ctx context.Context, i *EntUserMutator, c int, creator *ten.UserCreate) error {
			value := b.ageOverride
	...
	if b.mutation._postGroupsFunc != nil {
		postSlice = append(postSlice, func(ctx context.Context, i *ten.User, c int, creator *ten.UserCreate) error {
