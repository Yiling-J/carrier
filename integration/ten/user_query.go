...
import (
	...
	"github.com/Yiling-J/carrier/integration/ten/car"
	"github.com/Yiling-J/carrier/integration/ten/group"
	"github.com/Yiling-J/carrier/integration/ten/predicate"
	"github.com/Yiling-J/carrier/integration/ten/user"
)
...
func (uq *UserQuery) prepareQuery(ctx context.Context) error {
	for _, f := range uq.fields {
		if !user.ValidColumn(f) {
			return &ValidationError{Name: f, err: fmt.Errorf("ten: invalid field %q for query", f)}
		}
	}
	if uq.path != nil {
...
func (uq *UserQuery) sqlAll(ctx context.Context) ([]*User, error) {
	...
	_spec.Assign = func(columns []string, values []interface{}) error {
		if len(nodes) == 0 {
			return fmt.Errorf("ten: Assign called without calling ScanValues")
		}
...
func (uq *UserQuery) sqlExist(ctx context.Context) (bool, error) {
	...
	if err != nil {
		return false, fmt.Errorf("ten: check existence: %w", err)
	}
	return n > 0, nil
}
...
func (ugb *UserGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(ugb.fields) > 1 {
		return nil, errors.New("ten: UserGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := ugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ugb *UserGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("ten: UserGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ugb *UserGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(ugb.fields) > 1 {
		return nil, errors.New("ten: UserGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := ugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ugb *UserGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("ten: UserGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ugb *UserGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(ugb.fields) > 1 {
		return nil, errors.New("ten: UserGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := ugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ugb *UserGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("ten: UserGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ugb *UserGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(ugb.fields) > 1 {
		return nil, errors.New("ten: UserGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := ugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ugb *UserGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("ten: UserGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (us *UserSelect) Strings(ctx context.Context) ([]string, error) {
	if len(us.fields) > 1 {
		return nil, errors.New("ten: UserSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := us.Scan(ctx, &v); err != nil {
		return nil, err
...
func (us *UserSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("ten: UserSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (us *UserSelect) Ints(ctx context.Context) ([]int, error) {
	if len(us.fields) > 1 {
		return nil, errors.New("ten: UserSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := us.Scan(ctx, &v); err != nil {
		return nil, err
...
func (us *UserSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("ten: UserSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (us *UserSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(us.fields) > 1 {
		return nil, errors.New("ten: UserSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := us.Scan(ctx, &v); err != nil {
		return nil, err
...
func (us *UserSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("ten: UserSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (us *UserSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(us.fields) > 1 {
		return nil, errors.New("ten: UserSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := us.Scan(ctx, &v); err != nil {
		return nil, err
...
func (us *UserSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("ten: UserSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
